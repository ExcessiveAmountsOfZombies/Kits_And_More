...
public class BasicCurrency implements Currency {
    ...
    public BasicCurrency(ResourceLocation identifier) {
        ...
        this.currencySingularName = Component.literal("Dollar").setStyle(Constants.CONSTANTS_STYLE);
        this.currencyPluralName = Component.literal("Dollars").setStyle(Constants.CONSTANTS_STYLE);
        this.currencySymbol = Component.literal("$").setStyle(Constants.CONSTANTS_STYLE);
    }
    ...
    public Component format(double value, int decimalPlaces) {
        ...
        Component money = Component.literal(df.format(value)).setStyle(Constants.VARIABLE_STYLE);
